...
const { computeFoodNutrition, computeRecipeTotals, getFoodNutrition, getTypicalWeight, extractFoodKeywords, extractServingFromCommonUnit } = require('../nutritionService');
