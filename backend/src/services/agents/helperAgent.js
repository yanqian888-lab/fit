...
function shouldUseWebSearch(question, unknownFood) {
  ...
  const snackRe = /雪糕|冰淇淋|冰激凌|冰棍|棒冰|冰棒|甜筒|圣代|雪泥|薯片|薯条|虾条|锅巴|爆米花|沙琪玛|雪饼|米饼|月饼|烧饼|煎饼|蛋糕|年糕|面包|吐司|饼干|曲奇|蛋挞|泡芙|披萨|汉堡|巧克力|棉花糖|太妃糖|麦芽糖|软糖|奶糖|果冻|辣条|肉干|肉脯|豆干|香肠|火腿肠|凤爪|鸡爪|鸭脖|鸭翅|海苔|鱼片|话梅|蜜饯|瓜子|花生|核桃|腰果|开心果|巴旦木|松子|板栗|红枣|桂圆/;
...
function collectFoodCandidates(question) {
  ...
  const snackRe = /([\u4e00-\u9fa5]{0,8}(?:雪糕|冰淇淋|冰激凌|冰棍|棒冰|冰棒|甜筒|圣代|雪泥|薯片|薯条|虾条|锅巴|爆米花|沙琪玛|雪饼|米饼|月饼|烧饼|煎饼|蛋糕|年糕|面包|吐司|饼干|曲奇|蛋挞|泡芙|披萨|汉堡|巧克力|棉花糖|太妃糖|麦芽糖|软糖|奶糖|果冻|辣条|肉干|肉脯|豆干|香肠|火腿肠|凤爪|鸡爪|鸭脖|鸭翅|海苔|鱼片|话梅|蜜饯|瓜子|花生|核桃|腰果|开心果|巴旦木|松子|板栗|红枣|桂圆))/g;
