...
/**
 * 执行 mainAgent 决策出的工具调用（helper 问答 / 页面跳转）
...
function generateContextualFallbackReply(userMessage, history = [], partnerMode = 'gentle', userId = '') {
  ...
  const hasFood = /吃|喝|饭|菜|肉|蛋|奶|面|米|粥|包|饺|饼|糕|零食|奶茶|咖啡|水果|蔬菜|蛋糕|巧克力|冰淇淋|冰激凌|雪糕|薯片|薯条|坚果|酸奶|牛奶|豆浆|饮料|白开水|茶|鱼|虾|蟹|生蚝|扇贝|鱿鱼|三文鱼|鳗鱼|金枪鱼|榴莲|芒果|木瓜|菠萝|凤梨|山竹|火龙果|百香果|椰子|哈密瓜|杨梅|枇杷|柿子|柚子|奇异果|车厘子|桔子|番茄|马铃薯|地瓜|番薯|山药|芋头|莲藕|萝卜|茄子|韭菜|芹菜|菠菜|白菜|豆角|豆芽|西兰花|蘑菇|香菇|笋|元宵|泡面|方便面|螺蛳粉|米线|米粉|麻辣烫|火锅|烧烤|炸鸡|披萨|汉堡|三明治|寿司|刺身|沙拉|麦片|蛋卷|麻花|桃酥|威化|麻薯|牛轧糖|甜甜圈|卤蛋|果汁/.test(text);
