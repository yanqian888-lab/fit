...
const nameMap = {
  ...
  'pagesRecord/diet-detail': '饮食详情',
  'pagesRecord/add-food': '添加食物',
  'pagesRecord/create-food': '创建食物',
  'pagesRecord/food-detail': '食物详情',
  'pagesRecord/habit': '习惯记录',
  'pagesRecord/mood': '心情记录',
  'pagesRecord/exercise-detail': '运动详情',
  'pagesRecord/add-exercise': '添加运动',
  'pagesRecord/body-data': '身体数据',
  'pages/museum/index': '博物馆首页',
  'pagesMuseum/diary': '减脂日记',
  'pagesMuseum/diary-generate': '生成日记',
  'pagesMuseum/diary-detail': '日记详情',
  'pagesMuseum/milestones': '里程碑',
  'pagesMuseum/recipes': '食谱',
  'pagesMuseum/insights': '数据洞察',
  'pagesMuseum/item-edit': '项目编辑',
  'pagesMuseum/compare': '对比',
  'pagesMuseum/photo-upload': '照片上传',
  'pagesMuseum/recipe-detail': '食谱详情',
  'pagesMuseum/methods': '减肥方法',
